...
import 'dart:io';
import 'dart:ui';
// import 'package:collect/app/configuration/console.log.dart';
import 'package:collect/widgets/common/video_player.dart';
...
class _DarwinCameraState extends State<DarwinCamera>
  ...
  Widget getCaptureResultBody() {
    console.log('***** getCaptureResultBody *****');
    switch (cameraMode) {
      case CameraMode.BARCODE:
        return Stack(
          children: <Widget>[
  ...
  Widget previewCamera(cameraState) {
    console.log('INSIDE cameraState');
    if (cameraState == CameraState.CAPTURING) {
  ...
  void _handleResult({
    ...
    //       console.log('🎯 Move closer to the barcode');
    //     } else {
    //       cameraStateController(CameraState.CAPTURED);
    //     }
    //     return;
  ...
  Widget _buildResults() {
    ...
    console.log('🎊_scanResults: $cameraScanResults');

    if (cameraScanResults is! List<Barcode>) {
      console.log('💎_scanResults is! List<Barcode>');
      return noResultsWidget;
    }
  ...
  Future<void> compressFile(File file) async {
    // console.log('@@@@@@@@@@@@@@@@@ original file length: ${file.lengthSync()}');
    var result;
    if (cameraMode == CameraMode.VIDEO) {
      ...
      // console.log('@@@@@@@@@@@@@@@@@ new file length: ${file.lengthSync()}');
    } else {
    ...
    console.log(
        '^^^^^^^^^^^^^^^^^^^isFileCompressionDone: $isFileCompressionDone');
    setState(() {
